...
class ItemManager:
    ...
    def modify_character_equipment(self, character_name: str, story_context: str):
        """
        Processes an equipment change for a single, specified character.
        """
        character = roster_manager.find_character(self.engine, character_name)
        ...
        mod_kwargs = {"recent_events": story_context, "equipped_items_list": equipped_str}
        ...
        if items_to_add_names:
            desc_kwargs = {"item_names_list": "; ".join(items_to_add_names), "context": story_context}
